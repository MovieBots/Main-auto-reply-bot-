...
FROM_GRP = [int(channel_id) for channel_id in environ.get('FROM_GRP', '-1001629066592 -1001801025389 -1001673577866 -1002238709293').split() if re.match(r'^-?\d+$', channel_id)]
